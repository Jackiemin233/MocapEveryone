...
class FrameTracker:
    ...
    def track(self, frame: Frame):
       ...
       #idx_i2j, valid_match_j, Xii, Cii, Qii, Xji, Cji, Qji
        ...
        Qk = torch.sqrt(Qff[idx_f2k] * Qkf) # Matching confidence
        ...
        try:
            ...
            if not use_calib:
                ...
                T_WCf, T_CkCf = self.opt_pose_calib_sim3( # T_CkCf current and key frame transformation
                    Xf,
                    Xk,
                    T_WCf,
                    T_WCk,
